...
public class PlanDocument {
	...
	private int TOT_PARTCP_BOY_CNT;
	private int TOT_ACTIVE_PARTCP_CNT;
	private int RTD_SEP_PARTCP_RCVG_CNT;
	private int RTD_SEP_PARTCP_FUT_CNT;
	private int SUBTL_ACT_RTD_SEP_CNT;
	private int BENEF_RCVG_BNFT_CNT;
	private int TOT_ACT_RTD_SEP_BENEF_CNT;
	private int PARTCP_ACCOUNT_BAL_CNT;
	private int SEP_PARTCP_PARTL_VSTD_CNT;
	private int CONTRIB_EMPLRS_CNT;
	...
	private int TOT_ACT_PARTCP_BOY_CNT;
	...
	public int getTOT_PARTCP_BOY_CNT() {
		return TOT_PARTCP_BOY_CNT;
	}
	public void setTOT_PARTCP_BOY_CNT(int tOT_PARTCP_BOY_CNT) {
		TOT_PARTCP_BOY_CNT = tOT_PARTCP_BOY_CNT;
	}
	public int getTOT_ACTIVE_PARTCP_CNT() {
		return TOT_ACTIVE_PARTCP_CNT;
	}
	public void setTOT_ACTIVE_PARTCP_CNT(int tOT_ACTIVE_PARTCP_CNT) {
		TOT_ACTIVE_PARTCP_CNT = tOT_ACTIVE_PARTCP_CNT;
	}
	public int getRTD_SEP_PARTCP_RCVG_CNT() {
		return RTD_SEP_PARTCP_RCVG_CNT;
	}
	public void setRTD_SEP_PARTCP_RCVG_CNT(int rTD_SEP_PARTCP_RCVG_CNT) {
		RTD_SEP_PARTCP_RCVG_CNT = rTD_SEP_PARTCP_RCVG_CNT;
	}
	public int getRTD_SEP_PARTCP_FUT_CNT() {
		return RTD_SEP_PARTCP_FUT_CNT;
	}
	public void setRTD_SEP_PARTCP_FUT_CNT(int rTD_SEP_PARTCP_FUT_CNT) {
		RTD_SEP_PARTCP_FUT_CNT = rTD_SEP_PARTCP_FUT_CNT;
	}
	public int getSUBTL_ACT_RTD_SEP_CNT() {
		return SUBTL_ACT_RTD_SEP_CNT;
	}
	public void setSUBTL_ACT_RTD_SEP_CNT(int sUBTL_ACT_RTD_SEP_CNT) {
		SUBTL_ACT_RTD_SEP_CNT = sUBTL_ACT_RTD_SEP_CNT;
	}
	public int getBENEF_RCVG_BNFT_CNT() {
		return BENEF_RCVG_BNFT_CNT;
	}
	public void setBENEF_RCVG_BNFT_CNT(int bENEF_RCVG_BNFT_CNT) {
		BENEF_RCVG_BNFT_CNT = bENEF_RCVG_BNFT_CNT;
	}
	public int getTOT_ACT_RTD_SEP_BENEF_CNT() {
		return TOT_ACT_RTD_SEP_BENEF_CNT;
	}
	public void setTOT_ACT_RTD_SEP_BENEF_CNT(int tOT_ACT_RTD_SEP_BENEF_CNT) {
		TOT_ACT_RTD_SEP_BENEF_CNT = tOT_ACT_RTD_SEP_BENEF_CNT;
	}
	public int getPARTCP_ACCOUNT_BAL_CNT() {
		return PARTCP_ACCOUNT_BAL_CNT;
	}
	public void setPARTCP_ACCOUNT_BAL_CNT(int pARTCP_ACCOUNT_BAL_CNT) {
		PARTCP_ACCOUNT_BAL_CNT = pARTCP_ACCOUNT_BAL_CNT;
	}
	public int getSEP_PARTCP_PARTL_VSTD_CNT() {
		return SEP_PARTCP_PARTL_VSTD_CNT;
	}
	public void setSEP_PARTCP_PARTL_VSTD_CNT(int sEP_PARTCP_PARTL_VSTD_CNT) {
		SEP_PARTCP_PARTL_VSTD_CNT = sEP_PARTCP_PARTL_VSTD_CNT;
	}
	public int getCONTRIB_EMPLRS_CNT() {
		return CONTRIB_EMPLRS_CNT;
	}
	public void setCONTRIB_EMPLRS_CNT(int cONTRIB_EMPLRS_CNT) {
	...
	public int getTOT_ACT_PARTCP_BOY_CNT() {
		return TOT_ACT_PARTCP_BOY_CNT;
	}
	public void setTOT_ACT_PARTCP_BOY_CNT(int tOT_ACT_PARTCP_BOY_CNT) {
